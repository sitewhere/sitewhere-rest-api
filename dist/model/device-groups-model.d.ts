 ...
 */
export interface IDeviceGroupCreateRequest extends IBrandedEntityCreateRequest, IAccessible {
    roles: string[];
}
/**
 ...
 */
export interface IDeviceGroupSearchResults extends ISearchResults<IDeviceGroup> {
}
/**
 ...
 */
export interface IDeviceGroupElementSearchResults extends ISearchResults<IDeviceGroupElement> {
}
